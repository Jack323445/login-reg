...
// CHECK IF FIELDS ARE NOT EMPTY
    if(!empty(trim($_POST['username'])) && !empty(trim($_POST['user_email']))  && !empty(trim($_POST['user_password']))  && !empty($_POST['user_number'])){
...
// Escape special characters.
        ...
        $user_number = mysqli_real_escape_string($db_connection, htmlspecialchars($_POST['user_number']));
//IF EMAIL IS VALID
...
// INSERT USER INTO THE DATABASE
                $insert_user = mysqli_query($db_connection, "INSERT INTO `users` (username, user_email, user_number,user_password) VALUES ('$username', '$user_email', '$user_number', '$user_hash_password')");
